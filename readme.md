...
## Replace with your LinkedIn photo

1. Save your profile photo in the repo root as `profile-photo.jpg` (recommended 600x600).
2. In `index.html`, change `src="profile-photo.svg"` to `src="profile-photo.jpg"`.
